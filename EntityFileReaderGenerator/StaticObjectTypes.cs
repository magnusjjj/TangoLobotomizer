...
namespace PetriNoitaLib.V2
{
	internal class StaticObjectTypes
	{
        ...
        static StaticObjectTypes()
        {
            ...
            {
                throw new Exception(jo.Name);
            }*/
        }


        static string structurejson = @"{
    ""class ConfigExplosion"": [
        ...
        [
            ""explosion_sprite_emissive"",
            ""bool""
        ],
        [
            ""explosion_sprite_additive"",
            ""bool""
        ],
        [
        ...
        [
            ""destroy_non_platform_solid_enabled"",
            ""bool""
        ],
        [
            ""electricity_count"",
        ...
        [
            ""material_sparks_min_hp"",
            ""int""
        ],
        [
            ""material_sparks_probability"",
            ""int""
        ],
        [
            ""material_sparks_count_min"",
            ""int""
        ],
        [
        ...
        [
            ""material_sparks_enabled"",
            ""bool""
        ],
        [
            ""material_sparks_real"",
            ""bool""
        ],
        [
            ""material_sparks_scale_with_hp"",
            ""bool""
        ],
        [
            ""sparks_enabled"",
        ...
        [
            ""physics_multiplier_ragdoll_force"",
            ""float""
        ],
        [
        ...
        [
            ""audio_liquid_amount_normalized"",
            ""float""
        ],
        [
            ""delay"",
    ...
    ""class ConfigLaser"": [
        ...
        [
            ""damage_apply_hitbox_dmg_multiplier"",
            ""bool""
        ],
        [
            ""root_entity_is_responsible_for_damage"",
            ""bool""
        ]
    ],
    ""class ConfigDrugFx"": [
